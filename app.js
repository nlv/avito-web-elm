...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Button$Size = function (a) {
	return {$: 'Size', a: a};
};
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Button$small = EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Button$Size(EdutainmentLIVE$elm_bootstrap$Bootstrap$General$Internal$SM);
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							elm$html$Html$div,
							_List_fromArray(
								[EdutainmentLIVE$elm_bootstrap$Bootstrap$Utilities$Flex$inline]),
							_List_fromArray(
								[
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$Responsive = function (a) {
	return {$: 'Responsive', a: a};
};
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$responsive = EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$Responsive(elm$core$Maybe$Nothing);
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedCell = function (cell) {
	var inverseOptions = function (options) {
		return A2(
			...
			function (opt) {
				if (opt.$ === 'RoledCell') {
					var role = opt.a;
					return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$InversedCell(role);
				} else {
					return opt;
				}
			},
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedRow = function (row) {
	var inversedOptions = function (options) {
		return A2(
			...
			function (opt) {
				if (opt.$ === 'RoledRow') {
					var role = opt.a;
					return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$InversedRow(role);
				} else {
					return opt;
				}
			},
	...
	if (row.$ === 'Row') {
		...
		return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$Row(
			{
				cells: A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedCell, cells),
				options: inversedOptions(options)
			});
	} else {
		var options = row.a.options;
		var cells = row.a.cells;
		return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$KeyedRow(
			{
				cells: A2(
					elm$core$List$map,
					function (_n1) {
						...
						return _Utils_Tuple2(
							key,
							EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedCell(cell));
					},
					cells),
				options: inversedOptions(options)
			});
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeMapInversedTBody = F2(
			...
			if (_n0.b.$ === 'TBody') {
				...
				return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$TBody(
					_Utils_update(
						body,
						{
							rows: A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedRow, body.rows)
						}));
			} else {
				var keyedBody = _n0.b.a;
				return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$KeyedTBody(
					_Utils_update(
						keyedBody,
						{
							rows: A2(
								...
								function (_n1) {
									...
									return _Utils_Tuple2(
										key,
										EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$mapInversedRow(row));
								},
								keyedBody.rows)
						}));
			}
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$InversedHead = {$: 'InversedHead'};
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeMapInversedTHead = F2(
	function (isTableInversed, _n0) {
		var thead_ = _n0.a;
		var isHeadInversed = A2(
			elm$core$List$any,
			function (opt) {
				return _Utils_eq(opt, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$InversedHead);
			},
			thead_.options);
		return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$THead(
		...
		var responsiveClass = elm$html$Html$Attributes$class(
			'table-responsive' + A2(
				...
				A2(
					...
					A2(
						elm$core$Maybe$andThen,
						EdutainmentLIVE$elm_bootstrap$Bootstrap$General$Internal$screenSizeOption,
						A2(
							elm$core$Maybe$andThen,
							function (opt) {
								if (opt.$ === 'Responsive') {
							...
							elm$core$List$head(
								A2(elm$core$List$filter, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$isResponsive, options)))))));
		return A2(elm$core$List$any, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$isResponsive, options) ? A2(
			elm$html$Html$div,
			_List_fromArray(
				[responsiveClass]),
			_List_fromArray(
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeAddScopeToFirstCell = function (row) {
	if (row.$ === 'Row') {
		var options = row.a.options;
		var cells = row.a.cells;
		if (!cells.b) {
			...
			return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$Row(
				{
					cells: A2(
						elm$core$List$cons,
						EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$addScopeIfTh(first),
						rest),
					options: options
				});
		}
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$cellAttribute = function (option) {
	switch (option.$) {
		case 'RoledCell':
			if (option.a.$ === 'Roled') {
				var role = option.a.a;
				return A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Role$toClass, 'table', role);
			} else {
				var _n1 = option.a;
		...
		case 'InversedCell':
			if (option.a.$ === 'Roled') {
				var role = option.a.a;
				return A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Role$toClass, 'bg-', role);
			} else {
				var _n2 = option.a;
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$cellAttributes = function (options) {
	return A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$cellAttribute, options);
};
var elm$html$Html$td = _VirtualDom_node('td');
var elm$html$Html$th = _VirtualDom_node('th');
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderCell = function (cell) {
	if (cell.$ === 'Td') {
		var options = cell.a.options;
		var children = cell.a.children;
		return A2(
			elm$html$Html$td,
			EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$cellAttributes(options),
			children);
	} else {
		var options = cell.a.options;
		var children = cell.a.children;
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$rowClass = function (option) {
	switch (option.$) {
		case 'RoledRow':
			if (option.a.$ === 'Roled') {
				var role_ = option.a.a;
				return A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Role$toClass, 'table', role_);
			} else {
				var _n1 = option.a;
				return elm$html$Html$Attributes$class('table-active');
			}
		case 'InversedRow':
			if (option.a.$ === 'Roled') {
				var role_ = option.a.a;
				return A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Internal$Role$toClass, 'bg', role_);
			} else {
				var _n2 = option.a;
				return elm$html$Html$Attributes$class('bg-active');
			}
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$rowAttributes = function (options) {
	return A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$rowClass, options);
};
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderRow = function (row) {
	if (row.$ === 'Row') {
		var options = row.a.options;
		var cells = row.a.cells;
		return A2(
			elm$html$Html$tr,
			EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$rowAttributes(options),
			A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderCell, cells));
	} else {
		var options = row.a.options;
		var cells = row.a.cells;
		return A3(
			...
			A2(
				...
				function (_n1) {
					...
					return _Utils_Tuple2(
						key,
						EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderCell(cell));
				},
				cells));
	}
};
var elm$html$Html$tbody = _VirtualDom_node('tbody');
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderTBody = function (body) {
	if (body.$ === 'TBody') {
		...
		return A2(
			...
			A2(
				elm$core$List$map,
				function (row) {
					return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderRow(
						EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeAddScopeToFirstCell(row));
				},
				rows));
	} else {
		var attributes = body.a.attributes;
		...
		return A3(
			...
			A2(
				...
				function (_n1) {
					...
					return _Utils_Tuple2(
						key,
						EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderRow(
							EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeAddScopeToFirstCell(row)));
				},
				rows));
	}
};
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$theadAttribute = function (option) {
	switch (option.$) {
		case 'InversedHead':
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$theadAttributes = function (options) {
	return A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$theadAttribute, options);
};
var elm$html$Html$thead = _VirtualDom_node('thead');
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderTHead = function (_n0) {
	var options = _n0.a.options;
	var rows = _n0.a.rows;
	return A2(
		elm$html$Html$thead,
		EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$theadAttributes(options),
		A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderRow, rows));
};
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tableClass = function (option) {
	switch (option.$) {
		case 'Inversed':
			return elm$core$Maybe$Just(
...
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tableAttributes = function (options) {
	return A2(
		...
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			A2(elm$core$List$map, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tableClass, options)));
};
var elm$core$Basics$not = _Basics_not;
var elm$html$Html$table = _VirtualDom_node('table');
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$table = function (rec) {
	var isInversed = A2(
		elm$core$List$any,
		function (opt) {
			return _Utils_eq(opt, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$Inversed);
		},
		rec.options);
	var classOptions = A2(
		elm$core$List$filter,
		function (opt) {
			return !EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$isResponsive(opt);
		},
		rec.options);
	return A2(
		EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeWrapResponsive,
		rec.options,
		A2(
			elm$html$Html$table,
			EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tableAttributes(classOptions),
			_List_fromArray(
				[
					EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderTHead(
					A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeMapInversedTHead, isInversed, rec.thead)),
					EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$renderTBody(
					A2(EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$maybeMapInversedTBody, isInversed, rec.tbody))
				])));
};
var EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tbody = F2(
	...
	return EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$table(
		{
			options: _List_fromArray(
				[EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$bordered, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$hover, EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$responsive]),
			tbody: A2(
				EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$tbody,
				_List_Nil,
				_List_fromArray(
					[
			...
			thead: EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$simpleThead(
				A2(
					elm$core$List$map,
					EdutainmentLIVE$elm_bootstrap$Bootstrap$Table$th(_List_Nil),
					headP))
		});
};
...
var author$project$AvitoApp$main = elm$browser$Browser$sandbox(
	{init: author$project$AvitoApp$initModel, update: author$project$AvitoApp$update, view: author$project$AvitoApp$view});
